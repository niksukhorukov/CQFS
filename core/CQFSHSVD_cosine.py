...
class CQFSHSVD_cosine:
    SAVED_MODELS_FILE = 'saved_CQFSHSVD_cosine_models.zip'
    ...
    def __init__(self, ICM_train, URM_train, base_folder_path, *, sampler):
        ...
        self.solver = sampler
        self.selection_type = 'cqfs_hsvd_cosine'
    ...
    def select_p(self, ps, alpha_inv, rank_inv, deg_inv, vartype='BINARY', save_FPM=False):
        ...
        S_collab = cosine_similarity(self.URM_train.T, self.URM_train.T)
        ...
        response_time1 = time.time()
        item_saturated = L_S_maxvol.T @ diags(popularity) @ self.ICM_train
