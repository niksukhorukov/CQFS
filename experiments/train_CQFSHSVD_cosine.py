...
from core.CQFSHSVDTrainer import CQFSHSVDTrainer
...
def train_CQFSHSVD_cosine(
    ...
    for percentages, alphas, ranks, degs, CF_recommender_class in iterable:
        ...
        CQFS_selector = CQFSHSVD_cosine(ICM_train, S_CF, base_folder_path, sampler=sampler)

        ##################################################
        # Train CQFS ItemKNNCBFRecommender

        CQFS_trainer = CQFSHSVDTrainer(CQFS_selector, URM_train, URM_validation, URM_train_validation, URM_test, ICM_train,
        ...
        CQFS_trainer.train_many(percentages, alphas, ranks, degs, parameter_product=parameter_product,
                                cpu_count_div=cpu_count_div, cpu_count_sub=cpu_count_sub)
        CQFS_trainer.compute_statistics(S_CF, S_CBF, percentages, alphas, ranks, degs)
